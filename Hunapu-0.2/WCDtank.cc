...
// seq
  ...
  //---
  //  Create Detector
  WCDtankDetectorConstruction* detector = new WCDtankDetectorConstruction;
  runManager->SetUserInitialization(detector);
  //
  runManager->SetUserInitialization(new WCDtankPhysicsList);
  
  // UserAction classes
  runManager->SetUserInitialization(new WCDtankActionInitialization);
