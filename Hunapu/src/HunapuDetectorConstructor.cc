...
G4VPhysicalVolume* HunapuDetectorConstruction::Construct()
{
...
void HunapuDetectorConstruction::ConstructSDandField() {

  if (!SensitiveVolume) return;

  // PMT SD

  HunapuSensitiveDetector* HunapuSD = new HunapuSensitiveDetector("/Hunapu/HunapuSD");

  SetSensitiveDetector(SensitiveVolume, HunapuSD);
