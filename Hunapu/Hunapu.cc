...
int main(int argc,char** argv) {
  ...
  //---
  //  Create Detector
  HunapuDetectorConstruction* detector = new HunapuDetectorConstruction;
  runManager->SetUserInitialization(detector);
  //
  runManager->SetUserInitialization(new HunapuPhysicsList);
  
  // UserAction classes
  runManager->SetUserInitialization(new HunapuActionInitialization);
