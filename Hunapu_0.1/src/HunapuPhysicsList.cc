...
HunapuPhysicsList::HunapuPhysicsList()
 : G4VUserPhysicsList(),
...
void HunapuPhysicsList::ConstructParticle()
{
...
void HunapuPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructDecay();
  ConstructEM();
...
void HunapuPhysicsList::ConstructDecay()
{
  // Add Decay Process
...
void HunapuPhysicsList::ConstructEM()
{
  theParticleIterator->reset();
  while( (*theParticleIterator)() ){
    G4ParticleDefinition* particle = theParticleIterator->value();
...
void HunapuPhysicsList::ConstructOp()
{
...
void HunapuPhysicsList::SetCuts()
{
